...
public class MaxiSingle extends AppCompatActivity  implements
    ...
    TextView hand_sum2;
    TextView hand_sum3;
    TextView center_sum1;
    TextView center_sum2;
    TextView center_sum3;
    TextView sides_sum1;
    TextView sides_sum2;
    TextView sides_sum3;
    TextView yamb_sum1;
...
//    Down Down;
    ...
    Integer[] arrayCeo;
    int numOfThrows = 0;
    int value = 0, bacanja = 0;
    TextView back ;
    int maxMin = 0;
    int coins = 500;
    int lastHand = 0;
    int timeTotal = 0, min = 0, sec = 0;
    Dialog popupDialog;
    ...
    private void initLayout() {
        ...
        center_sum1 = (TextView) findViewById(R.id.center_sum1);
        center_sum2 = (TextView) findViewById(R.id.center_sum2);
        center_sum3 = (TextView) findViewById(R.id.center_sum3);
        sides_sum1 = (TextView) findViewById(R.id.sides_sum1);
        sides_sum2 = (TextView) findViewById(R.id.sides_sum2);
        sides_sum3 = (TextView) findViewById(R.id.sides_sum3);
    ...
    public void SVE(int i, TextView textView) {
        if (i == 0 || i == 25 || i == 58 || i == 59 || i == 65 || i == 77) {
            arrayCeo[i] = write(i);
            ...
            if(soundON)
                mp_write.start();
        } else if (((i < 13 && i > 0) || (i < 65 && i > 59) || (i < 72 && i > 65)) && arrayCeo[i - 1] != -1) {
            arrayCeo[i] = write(i);
            textView.setText(String.valueOf(arrayCeo[i]));
            back = textView;
            played(i);
            ...
            if(soundON)
                mp_write.start();
        } else if (((i > 12 && i < 25) || (i > 51 && i < 58) || (i > 71 && i < 77)) && arrayCeo[i + 1] != -1) {
            arrayCeo[i] = write(i);
            textView.setText(String.valueOf(arrayCeo[i]));
            back = textView;
            played(i);
    ...
    public void played(int i) {
        ...
        bacanja = numOfThrows;
        numOfThrows = 0;
        GlideApp.with(MaxiSingle.this).load(R.drawable.unknown).diskCacheStrategy(DiskCacheStrategy.NONE)
        ...
        GlideApp.with(MaxiSingle.this).load(R.drawable.play).diskCacheStrategy(DiskCacheStrategy.NONE)
    ...
    public void random(ImageView imageView, int i) {
        ...
        try {
            if (arrayDicesState[i] && imageView != null) {
                switch (n) {
                    case 1: {
                        GlideApp.with(MaxiSingle.this).load(R.drawable.orange1).diskCacheStrategy(DiskCacheStrategy.NONE)
                                .skipMemoryCache(true).into(imageView);
                    }
                    break;
                    case 2: {
                        GlideApp.with(MaxiSingle.this).load(R.drawable.orange2).diskCacheStrategy(DiskCacheStrategy.NONE)
                                .skipMemoryCache(true).into(imageView);
                    }
                    break;
                    case 3: {
                        GlideApp.with(MaxiSingle.this).load(R.drawable.orange3).diskCacheStrategy(DiskCacheStrategy.NONE)
                                .skipMemoryCache(true).into(imageView);
                    }
                    break;
                    case 4: {
                        GlideApp.with(MaxiSingle.this).load(R.drawable.orange4).diskCacheStrategy(DiskCacheStrategy.NONE)
                                .skipMemoryCache(true).into(imageView);
                    }
                    break;
                    case 5: {
                        GlideApp.with(MaxiSingle.this).load(R.drawable.orange5).diskCacheStrategy(DiskCacheStrategy.NONE)
                                .skipMemoryCache(true).into(imageView);
                    }
                    break;
                    case 6: {
                        GlideApp.with(MaxiSingle.this).load(R.drawable.orange6).diskCacheStrategy(DiskCacheStrategy.NONE)
                                .skipMemoryCache(true).into(imageView);
                    }
                    break;
                }
            ...
            if (!arrayDicesState[i]) {
                ...
                if(sel <= 4){
                    ...
                    switch (arrayDicesValue[i]) {
                        ...
                        case 1:
                            GlideApp.with(MaxiSingle.this).load(R.drawable.red1).diskCacheStrategy(DiskCacheStrategy.NONE)
                                    .skipMemoryCache(true).into(imageView);
                            break;
                        case 2:
                            GlideApp.with(MaxiSingle.this).load(R.drawable.red2).diskCacheStrategy(DiskCacheStrategy.NONE)
                                    .skipMemoryCache(true).into(imageView);
                            break;
                        case 3:
                            GlideApp.with(MaxiSingle.this).load(R.drawable.red3).diskCacheStrategy(DiskCacheStrategy.NONE)
                                    .skipMemoryCache(true).into(imageView);
                            break;
                        case 4:
                            GlideApp.with(MaxiSingle.this).load(R.drawable.red4).diskCacheStrategy(DiskCacheStrategy.NONE)
                                    .skipMemoryCache(true).into(imageView);
                            break;
                        case 5:
                            GlideApp.with(MaxiSingle.this).load(R.drawable.red5).diskCacheStrategy(DiskCacheStrategy.NONE)
                                    .skipMemoryCache(true).into(imageView);
                            break;
                        case 6:
                            GlideApp.with(MaxiSingle.this).load(R.drawable.red6).diskCacheStrategy(DiskCacheStrategy.NONE)
                                    .skipMemoryCache(true).into(imageView);
                            break;
                    }
                }
    ...
    public void swapPlay(ImageView imageView) {
        ...
        try
        {
            if(numOfThrows == 1)
            {
                ...
                eraser.setClickable(false);
                GlideApp.with(MaxiSingle.this).load(R.drawable.play1).diskCacheStrategy(DiskCacheStrategy.NONE)
                        .skipMemoryCache(true).into(imageView);
            }
            if(numOfThrows == 2)
            {
                GlideApp.with(MaxiSingle.this).load(R.drawable.play2).diskCacheStrategy(DiskCacheStrategy.NONE)
                        .skipMemoryCache(true).into(imageView);
            }
            if(numOfThrows == 3)
            {
                GlideApp.with(MaxiSingle.this).load(R.drawable.play3).diskCacheStrategy(DiskCacheStrategy.NONE)
                        .skipMemoryCache(true).into(imageView);
                play.setClickable(false);
    ...
    public int write (int i) {
        int sum = 0;
        if ((i >= 0 && i <= 5) || (i >= 13 && i <= 18) || (i >= 26 && i <= 31) || (i >= 39 && i <= 44) || (i >= 52 && i <= 57)|| (i >= 65 && i <= 70)) {
            for (int j = 0; j < 6; j++) {
                if (!arrayDicesState[j]) {
                    if (arrayDicesValue[j] == i + 1)
                        ...
                        sum += (i - 38);
                    else if(arrayDicesValue[j] == i - 51)
                        sum += (i - 51);
                    else if(arrayDicesValue[j] == i - 64)
                        sum += (i - 64);
                }
            }
        }
        else if (i == 6 || i == 7 || i == 19 || i == 20 || i == 32 || i == 33 || i == 45 || i == 46 || i == 58  || i == 59 || i == 71 || i == 72) {
            for (int j = 0; j < 6; j++) {
                if (!arrayDicesState[j])
                    sum += arrayDicesValue[j];
            }
        }
        else if (i == 8  || i == 21 || i == 34 || i == 47 || i == 60 || i == 73) {
            int[] kenta = {2,3,4,5};
            int l = 0;
            for(int j = 0; j < 6; j++){
                for(int k = 0; k < 4; k++){
        ...
        else if((i >= 9 && i <= 12) || (i >= 22 && i <= 25) || (i >= 35 && i <= 38) || (i >= 48 && i <= 51)|| (i >= 61 && i <= 64)|| (i >= 74 && i <= 77))
        {
            int x = 0;
            int n = 0;
            int sf = 0;
            if (i == 9 || i == 10 || i == 22 || i == 23 || i == 35 || i == 36 || i == 48 || i == 49 || i == 61 || i == 62 || i == 74 || i == 75){
                x = 3;
                n = 20;
            }
            else if (i == 11 || i == 24 || i == 37 || i == 50 || i == 63 || i == 76) {
                x = 4;
                n = 40;
            }
            else if (i == 12 || i == 25 || i == 38 || i == 51 || i == 64 || i == 77){
                x = 5;
                n = 50;
            }
            for(int m = 0; m < 6; m++){
                ...
                if ( (i == 10 || i == 23 || i == 36 || i == 49 || i == 62 || i == 75) && sum != 0 ) {
                    int sum1 = 0;
                    for(int a = 0; a < 6; a++) {
                        int count1;
                        for (int k = 1; k < 7; k++) {
    ...
    public int oneToSixSum() {
        ...
        if(sum4 != 0)
            ...
            hand_sum1.setText("");
        if(sum5 != 0)
            center_sum1.setText(String.valueOf(sum5));
        else
            center_sum1.setText("");
        if(sum6 != 0)
            sides_sum1.setText(String.valueOf(sum6));
        else
            sides_sum1.setText("");
    ...
    public int MaxMinSum(){
        ...
        if (arrayCeo[59] != -1 && arrayCeo[52] != -1)
        ...
        if(sum4 != 0)
            ...
            hand_sum2.setText("");
        if(sum5 != 0)
            center_sum2.setText(String.valueOf(sum5));
        else
            center_sum2.setText("");
        if(sum6 != 0)
            sides_sum2.setText(String.valueOf(sum6));
        else
            sides_sum2.setText("");
    ...
    public int TheLastOne(){
        ...
        if(sum4 != 0)
            ...
            hand_sum3.setText("");
        if(sum5 != 0)
            center_sum3.setText(String.valueOf(sum5));
        else
            center_sum3.setText("");
        if(sum6 != 0)
            sides_sum3.setText(String.valueOf(sum6));
        else
            sides_sum3.setText("");
        ...
        if(n == 0) {
            ...
            profileRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    switch (dataSnapshot.getValue(int.class)) {
                        case 0:
                            profilepop.setBackgroundResource(R.drawable.avatar_ridji);
                            break;
                        case 1:
                            profilepop.setBackgroundResource(R.drawable.avatar_plavi);
                            break;
                        case 2:
                            profilepop.setBackgroundResource(R.drawable.avatar_zeleni);
                            break;
                    }
                }
    ...
    public void onClick(View v) {
        ...
        if (numOfThrows != 0) {
            switch (v.getId()) {
                ...
                case R.id.sides_max:
                    if (arrayCeo[71] == -1 && arrayCeo[70] != -1)
                        if (maxMin == 5)
                            SVE(71, sides_max);
                        else
                            Toast.makeText(this, "You must select 5 dice", Toast.LENGTH_SHORT).show();
                ...
                case R.id.sides_min:
                    if (arrayCeo[72] == -1 && arrayCeo[73] != -1)
                        if (maxMin == 5)
                            SVE(72, sides_min);
                        else
                            Toast.makeText(this, "You must select 5 dice", Toast.LENGTH_SHORT).show();
