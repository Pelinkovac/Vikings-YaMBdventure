...
public class MiniSingle extends AppCompatActivity  implements
...
////////////////////////////////////////////////
    ...
    public void played(int i) {
        ...
        bacanja = numOfThrows;
        numOfThrows = 0;
        GlideApp.with(MiniSingle.this).load(R.drawable.unknown).diskCacheStrategy(DiskCacheStrategy.NONE)
        ...
        GlideApp.with(MiniSingle.this).load(R.drawable.play).diskCacheStrategy(DiskCacheStrategy.NONE)
    ...
    public void random(ImageView imageView, int i) {
        ...
        try {
            if (arrayDicesState[i] && imageView != null) {
                switch (n) {
                    case 1: {
                        GlideApp.with(MiniSingle.this).load(R.drawable.orange1).diskCacheStrategy(DiskCacheStrategy.NONE)
                                .skipMemoryCache(true).into(imageView);
                    }
                    break;
                    case 2: {
                        GlideApp.with(MiniSingle.this).load(R.drawable.orange2).diskCacheStrategy(DiskCacheStrategy.NONE)
                                .skipMemoryCache(true).into(imageView);
                    }
                    break;
                    case 3: {
                        GlideApp.with(MiniSingle.this).load(R.drawable.orange3).diskCacheStrategy(DiskCacheStrategy.NONE)
                                .skipMemoryCache(true).into(imageView);
                    }
                    break;
                    case 4: {
                        GlideApp.with(MiniSingle.this).load(R.drawable.orange4).diskCacheStrategy(DiskCacheStrategy.NONE)
                                .skipMemoryCache(true).into(imageView);
                    }
                    break;
                    case 5: {
                        GlideApp.with(MiniSingle.this).load(R.drawable.orange5).diskCacheStrategy(DiskCacheStrategy.NONE)
                                .skipMemoryCache(true).into(imageView);
                    }
                    break;
                    case 6: {
                        GlideApp.with(MiniSingle.this).load(R.drawable.orange6).diskCacheStrategy(DiskCacheStrategy.NONE)
                                .skipMemoryCache(true).into(imageView);
                    }
                    break;
                }
            ...
            if (!arrayDicesState[i]) {
                ...
                if (sel <= 4) {
                    ...
                    switch (arrayDicesValue[i]) {
                        ...
                        case 1:
                            GlideApp.with(MiniSingle.this).load(R.drawable.red1).diskCacheStrategy(DiskCacheStrategy.NONE)
                                    .skipMemoryCache(true).into(imageView);
                            break;
                        case 2:
                            GlideApp.with(MiniSingle.this).load(R.drawable.red2).diskCacheStrategy(DiskCacheStrategy.NONE)
                                    .skipMemoryCache(true).into(imageView);
                            break;
                        case 3:
                            GlideApp.with(MiniSingle.this).load(R.drawable.red3).diskCacheStrategy(DiskCacheStrategy.NONE)
                                    .skipMemoryCache(true).into(imageView);
                            break;
                        case 4:
                            GlideApp.with(MiniSingle.this).load(R.drawable.red4).diskCacheStrategy(DiskCacheStrategy.NONE)
                                    .skipMemoryCache(true).into(imageView);
                            break;
                        case 5:
                            GlideApp.with(MiniSingle.this).load(R.drawable.red5).diskCacheStrategy(DiskCacheStrategy.NONE)
                                    .skipMemoryCache(true).into(imageView);
                            break;
                        case 6:
                            GlideApp.with(MiniSingle.this).load(R.drawable.red6).diskCacheStrategy(DiskCacheStrategy.NONE)
                                    .skipMemoryCache(true).into(imageView);
                            break;
                    }
                }
    ...
    public void swapPlay(ImageView imageView) {
        ...
        try {
            if (numOfThrows == 1) {
                ...
                eraser.setClickable(false);
                GlideApp.with(MiniSingle.this).load(R.drawable.play1).diskCacheStrategy(DiskCacheStrategy.NONE)
                        .skipMemoryCache(true).into(imageView);
            }
            if (numOfThrows == 2) {
                GlideApp.with(MiniSingle.this).load(R.drawable.play2).diskCacheStrategy(DiskCacheStrategy.NONE)
                        .skipMemoryCache(true).into(imageView);
            }
            if (numOfThrows == 3) {
                GlideApp.with(MiniSingle.this).load(R.drawable.play3).diskCacheStrategy(DiskCacheStrategy.NONE)
                        .skipMemoryCache(true).into(imageView);
                play.setClickable(false);
    ...
    public void End() {
        ...
        if (n == 0) {
            ...
            close = (TextView) popupDialog.findViewById(R.id.close);
